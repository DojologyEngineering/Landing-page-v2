    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-6 w-full lg:flex-row">
          ...
          <motion.div
            variants={item}
            className="relative flex items-center justify-center w-full lg:w-[462px] h-[300px] sm:h-[360px] lg:h-[428px] flex-shrink-0 rounded-[20px] before:absolute before:top-0 before:left-0 before:right-0 before:h-[1px] before:rounded-t-[20px] before:pointer-events-none"
            style={{
          ...
          >
            ...
            <div 
              className="flex flex-col justify-center items-center relative w-full lg:w-[422px] h-full lg:h-[388px] absolute rounded-xl overflow-hidden group"
              style={{
          ...
          <motion.div
            variants={item}
            className="relative flex items-center justify-center w-full lg:w-[562px] h-[300px] sm:h-[360px] lg:h-[428px] flex-shrink-0 rounded-[20px]"
            style={{
              background: "var(--color-card-bg)"
            }}
          >
            ...
            <div 
              className="flex flex-col justify-center items-center relative overflow-hidden w-full lg:w-[530px] h-full lg:h-[388px] gap-0.5 rounded-xl bg-cover bg-center bg-no-repeat group"
              style={{
        ...
        <motion.div
          variants={item}
          className="relative flex items-center justify-center w-full lg:w-[1052px] h-auto lg:h-[428px] flex-shrink-0 rounded-[20px]"
          style={{
            background: "var(--color-card-bg)"
          }}
        >
          ...
          <div 
            className="flex flex-col lg:flex-row items-start lg:items-center justify-between px-6 lg:px-12 w-full lg:w-[1012px] py-8 lg:py-0 lg:h-[388px] rounded-xl overflow-hidden group relative"
            style={{
              background: "linear-gradient(0deg, var(--color-card-overlay-start) 0%, var(--color-card-overlay-end) 100%)"
            }}
          >
