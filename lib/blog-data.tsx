...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: (
      <div className="font-['Manrope',sans-serif] font-normal relative shrink-0 text-[20px] md:text-[24px] text-white w-full space-y-6">
        ...
        <h2 className="leading-[normal] pt-6 text-[28px] md:text-[32px] font-bold">The Shift from Vendor to Partner</h2>
        ...
        <h2 className="leading-[normal] pt-6 text-[28px] md:text-[32px] font-bold">Why We Choose the Equity Model</h2>
        ...
        <ul className="ml-6 list-disc space-y-3 leading-[normal]">
        ...
        <h2 className="leading-[normal] pt-6 text-[28px] md:text-[32px] font-bold">What We Look for in a Partnership</h2>
        ...
        <ol className="ml-6 list-decimal space-y-3 leading-[normal]">
        ...
        <h2 className="leading-[normal] pt-6 text-[28px] md:text-[32px] font-bold">How the Process Works</h2>
        ...
        <h2 className="leading-[normal] pt-6 text-[28px] md:text-[32px] font-bold">Let&apos;s Build the Future</h2>
        ...
        <CollaborateButton className="mt-2 rounded-[8px] bg-[#34CB4D] px-6 py-3 text-base font-normal text-[#0A0A0A] transition-colors hover:bg-[#2fb846]">
  ...
  },
  {
    ...
    content: (
      <div className="font-['Manrope',sans-serif] font-normal relative shrink-0 text-[20px] md:text-[24px] text-white w-full space-y-6">
        ...
        <h2 className="leading-[normal] pt-6 text-[28px] md:text-[32px] font-bold">Month 1: The Architecture of an Idea</h2>
        ...
        <h2 className="leading-[normal] pt-6 text-[28px] md:text-[32px] font-bold">Month 2: The Power of Flutter for Web and Mobile</h2>
        ...
        <h2 className="leading-[normal] pt-6 text-[28px] md:text-[32px] font-bold">Month 3: Refinement and the Store Gauntlet</h2>
        ...
        <h2 className="leading-[normal] pt-6 text-[28px] md:text-[32px] font-bold">The Result: Day 90</h2>
        ...
        <h2 className="leading-[normal] pt-6 text-[28px] md:text-[32px] font-bold">Ready to Start Your 90-Day Countdown?</h2>
